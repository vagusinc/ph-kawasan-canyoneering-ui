  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="flex flex-col gap-3 w-full">
        <div
          className="p-3 flex items-center bg-primary-100 border border-black rounded-lg cursor-pointer"
          onClick={toggle}
        >
          <p className="flex-1 font-bold text-base text-black">
            {props.question}
          </p>
        ...
        {!isCollapsed && (
          <div className="p-3 bg-primary-100 border border-black rounded-lg">
            <p className="font-bold text-base text-black">{props.answer}</p>
          </div>
        )}
      </div>
    </div>
